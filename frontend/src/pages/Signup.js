...
export default function Signup() {
  ...
  return (
    <div className="relative min-h-[70vh] flex items-center justify-center px-4 overflow-hidden">
      ...
      <div className="ambient-glow w-96 h-96 bg-cyan-600/10 -top-12 -right-12"></div>
      <div className="ambient-glow w-96 h-96 bg-violet-600/15 -bottom-12 -left-12"></div>
      ...
      <div className="w-full max-w-md glass-card rounded-2xl p-8 relative z-10 animate-fade-in">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 mt-2 text-sm">
            Get started shortening links with advanced analytics
          </p>
        </div>
